...
public class ESignatureUtils {
    ...
    private static byte[] makeHash(byte[] message) {
        //  H = H0
        System.arraycopy(H0, 0, H, 0, H0.length);

        int[] words = toIntArray(pad(message));

        // пронумеровать все блоки (в каждом по 16 слов)
        for (int i = 0, n = words.length / 16; i < n; ++i) {

            // проинициализировать W из слов блока
    ...
    /**
     * Добавление единичного бита и добавление К 0 битов
     *
    ...
    /**
     * Конвертирует байтовый массив в массив int (4 байта в 1 инт)
     *
     * @param bytes исходный массив.
     * @return конвертированный массив.
     */
    ...
    /**
     * конвертирует массив int в байтовый массив (1 инт в 4 байта)
     *
